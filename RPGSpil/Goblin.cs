...
public class Goblin
{
    //laver en variabel ved navn liv inde for objektet Goblin
    private int _liv = 20;
    public int Liv                        
    {                                     
    ...
    //laver en variabel ved navn energi inde for objektet Goblin
    ...
    //laver en metode ved navn light som er et angreb for Goblin
